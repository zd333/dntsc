...
import { ClinicsDbConnectorService } from '../../../sub-features/clinics/services/clinics-db-connector.service';
import { PlatformFeatures } from '../../../sub-features/tenants/db-schemas/tenant.db-schema';
import { Reflector } from '@nestjs/core';
import { TenantsDbConnectorService } from '../../../sub-features/tenants/services/tenants-db-connector.service';
import {
  ReflectMetadata,
  Injectable,
  CanActivate,
