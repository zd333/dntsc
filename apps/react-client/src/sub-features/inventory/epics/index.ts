...
import { stopFilteringItemsOnNavigationToInventoryCatalogEpic } from './stop-filtering-items-on-navigation-to-inventory-catalog.epic';
...
export const inventoryEpics: Array<Epic> = [
  ...
  stopFilteringItemsOnNavigationToInventoryCatalogEpic,
